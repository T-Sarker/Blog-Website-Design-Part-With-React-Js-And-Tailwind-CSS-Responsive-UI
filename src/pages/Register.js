import React from "react"; import { NavLink } from "react-router-dom"; import { FaFacebookF, FaGit, FaGoogle } from "react-icons/fa"; const Register = () => {
    return (
        <div>
                ...
                <div className="h-full">
                    <div className="g-6 flex h-full flex-wrap items-center justify-center">
                        ...
                        <div className="mb-12 md:mb-0 md:w-8/12 lg:w-5/11 xl:w-5/12">
                            ...
                            <form className="w-810%">
                                <div className="relative mb-6" data-te-input-wrapper-init>
                                    <label htmlFor="username" className="pointer-events-none  left-3 top-0 mb-0 max-w-[60%] ">
                                        Username
                                    </label>
                                    <input type="text" className="peer block min-h-[auto] w-full rounded border-0 bg-gray-200 px-3 py-1 leading-[2.15] outline-none" placeholder="Email " id="username" name="username" />
                                </div>
                                <div className="relative mb-6" data-te-input-wrapper-init>
                                ...
                                <div className="text-center lg:text-left">
                                    <button type="button" className="inline-block border shadow-lg rounded bg-primary px-7 pb-2.5 pt-3 text-sm font-medium uppercase leading-normal text-black" data-te-ripple-init data-te-ripple-color="light">
                                        Register
                                    </button>
                                </div>
                            </form>
